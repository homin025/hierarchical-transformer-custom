...
def rouge_results_to_str(results_dict):
    return "[ROUGE F-SCORE] ROUGE-F(1/2/3/l): {:.2f}/{:.2f}/{:.2f}\n[ROUGE RECALL] ROUGE-R(1/2/3/l): {:.2f}/{:.2f}/{:.2f}\n".format(
...
class Rouge155(object):
    ...
    def __get_eval_string(
        ...
        """.format(task_id=task_id, model_root=model_dir, model_elems=model_elems, peer_root=system_dir,
